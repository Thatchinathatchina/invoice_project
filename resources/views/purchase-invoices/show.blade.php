<x-modal name="view-invoice" maxWidth="6xl">
    <div class="bg-gray-50 px-6 pt-6 pb-6 relative min-h-[80vh]">
        ...
        <div class="mb-6">
            <h3 class="text-xl font-bold text-gray-900">Saved Purchase Invoice</h3>
            ...
            <div class="w-full md:w-1/3 flex justify-center md:sticky md:top-6 bg-white p-6 shadow-sm border border-gray-200" style="font-family: 'Courier New', Courier, monospace; max-width: 380px; color: #333; border-style: dashed; border-width: 1px;" id="thermal-receipt-container">
                <div class="w-full">
                    ...
                    <div class="border-t border-dashed border-gray-300 pt-3 pb-3 mb-3 text-xs space-y-1">
                        ...
                        <div class="flex justify-between">
                            <span>Supplier</span>
                            <span class="font-semibold" x-text="viewForm.supplier_name"></span>
                        </div>
                        <div class="flex justify-between">
                            <span>Email</span>
                            <span x-text="viewForm.supplier_email || '-'"></span>
                        </div>
                        <div class="flex justify-between">
                            <span>Mobile</span>
                            <span x-text="viewForm.supplier_phone || '-'"></span>
                        </div>
                        <div class="flex justify-between">
                    ...
                    <div class="p-5 border-b border-gray-100 hover:bg-gray-50 transition">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-500 mb-3">Send this invoice directly to the supplier's inbox.</p>
                                <div class="flex gap-2">
                                    <input type="email" class="flex-1 text-sm border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-lg shadow-sm py-2" x-model="viewForm.supplier_email" placeholder="Email address">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex gap-2 mb-2">
                                    <div class="flex flex-1">
                                        ...
                                        <input type="text" class="flex-1 text-sm border-gray-300 rounded-r-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500 py-2" x-model="viewForm.supplier_phone" placeholder="Mobile number">
                                    </div>
