<x-modal name="delete-customer" maxWidth="md">
    <div class="bg-white px-6 pt-6 pb-6 text-center">
        ...
        <div class="mb-6">
            <h3 class="text-xl font-bold text-gray-900">Delete Customer</h3>
        ...
        <form :action="deleteAction" method="POST">
            ...
            <div class="flex items-center justify-center space-x-3 mt-5">
                <x-buttons.cancel @click="$dispatch('close-modal', 'delete-customer')" class="w-1/2">Cancel</x-buttons.cancel>
